...
\item Posługujemy się czcionkami z rodziny \texttt{newtxtext} oraz \texttt{newtxmath} (klon Times New Roman) w~całym dokumencie — strona tytułowa, streszczenia, rozdziały i podpisy. Listingi kodu używają czcionki maszynowej (\texttt{\textbackslash ttfamily}). Nagłówki: rozdział 14~pt, podrozdział 13~pt, drugi rząd 12~pt (wymogi edytorskie WIT). 
